...
public extension Parsing.Engine {
	typealias	Cursor	=	Parsing.Cursor
	typealias	Rule	=	Parsing.Rule
	typealias	Code	=	Parsing.Code
...
public extension Parsing.Engine.Stepping {
	public var description:String {
		get {
...
func + (left:Parsing.Engine.Stepping.NodeList, right:Parsing.Engine.Stepping.NodeList) -> Parsing.Engine.Stepping.NodeList {
	return	Parsing.Engine.Stepping.NodeList(left._items + right._items)
}
func += (inout left:Parsing.Engine.Stepping.NodeList, right:Parsing.Engine.Stepping.NodeList) {
	left	=	left + right
}



public extension Parsing.Engine.Stepping.NodeList {
